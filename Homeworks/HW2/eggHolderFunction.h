...
#ifndef EGGHOLDER_FUNC_H
#define EGGHOLDER_FUNC_H

class eggHolderFunction : public twoVariableEnergyFunc
{
public:
    // Constructor and Destructor declaration
    eggHolderFunction ( );
    eggHolderFunction ( vector<PCReal> _position );
    eggHolderFunction ( PCReal _x, PCReal _y );
    virtual ~eggHolderFunction ( );
